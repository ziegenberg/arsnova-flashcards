...
export let MarkdeepContent = class MarkdeepContent {
	...
	static exportContent (cards, cardset, whitelist) {
		...
		content += " | " + linebreak;
		content += "---|---" + linebreak;
		content += TAPi18n.__('cardset.info.author') + tableColumn + Profile.getAuthorName(cardset.owner, false) + linebreak;
		if (cardset.originalAuthorName !== undefined &&  (cardset.originalAuthorName.birthname !== undefined || cardset.originalAuthorName.legacyName !== undefined)) {
			content += TAPi18n.__('cardset.info.originalAuthor') + tableColumn + Profile.getOriginalAuthorName(cardset.originalAuthorName, false) + linebreak;
		}
