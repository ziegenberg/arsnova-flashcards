import * as config from "../config/transcriptBonus";
...
export let TranscriptBonusList = class TranscriptBonusList {
	...
	static getLectureEnd (transcriptBonus, date) {
		if (transcriptBonus.lectureEnd !== undefined) {
			...
			return result += MiscUtilities.getMomentsDate(lectureEnd, false);
		}
	}
	...
	static getDeadline (transcriptBonus, date_id) {
		if (transcriptBonus.lectureEnd !== undefined) {
			...
			return TAPi18n.__('transcriptForm.deadline.submission') + ": " + MiscUtilities.getMomentsDate(deadline, true, 1);
		}
	}
	...
	static getDeadlineEditing (transcriptBonus, date_id, displayMode = 0) {
		if (transcriptBonus.lectureEnd !== undefined) {
			...
			switch (displayMode) {
				case 0:
					return TAPi18n.__('transcriptForm.deadline.editing') + ": " + MiscUtilities.getMomentsDate(deadlineEditing, true, 1);
				case 1:
					return MiscUtilities.getMomentsDate(deadlineEditing, true, 2, false);
				case 2:
					return MiscUtilities.getMomentsDate(deadlineEditing, true, 1);
			}
		}
	}
