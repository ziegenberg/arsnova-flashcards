...
import {SweetAlertMessages} from "./sweetAlertMessages";
...
export let BonusForm = class BonusForm {
	...
	static createSnapshotDates () {
		...
		for (let i = 1; i < 6; i++) {
			...
			snapshotDates.push(MiscUtilities.getMomentsDateShort(newDate));
		}
		snapshotDates.push(MiscUtilities.getMomentsDateShort(bonusEnd));
